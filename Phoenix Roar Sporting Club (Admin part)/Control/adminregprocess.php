...
// }
    ...
    $mydb = new mydb();
    $conobj=$mydb->opencon();
    $mydb->insertreg($conobj,"adminreg",$_POST["fname"],$_POST["lname"],$_POST["age"],$_POST["adusername"],$_POST["password"],$_POST["conpassword"],$_POST["number"],$_POST["email"],$_POST["radio1"],$_POST["dob"],$_POST["radio1"],$cm);
