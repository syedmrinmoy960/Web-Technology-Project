...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2022 at 08:07 AM
...
INSERT INTO `service` (`Id`, `Firstname`, `Lastname`, `Age`, `Adminusername`, `password`, `confrimpassword`, `Number`, `email`, `Gender`, `Dateofbirth`, `maritalstatus`, `Bloodgroup`) VALUES
...
(11, 'adv', 'shabu', 60, 'shabu123', 12345, 12345, 1711472142, 'shabu123@gmail.com', 'single', '2022-08-07 00:00:00', 'single', 'AB+');
